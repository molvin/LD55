...
public static class Runes
{
    ...
    private static Rune Abundance => new()
    {
        ...
        OnActivate = (int selfIndex, Player player) =>
        {
            if (player.HandSize > 0)
            {
                ...
                return new() { EventHistory.PowerToSummon(player.GetCirclePower(), player.HandSize * 10) };
            }
    ...
    private static Rune Avarice => new()
    {
        ...
        OnActivate = (int selfIndex, Player player) =>
        {
            ...
            return new() { EventHistory.PowerToSummon(player.GetCirclePower(), circlePower) };
        },
    };
    // B
    ...
    private static Rune Bonfire => new()
    {
        ...
        OnActivate = (int selfIndex, Player player) =>
        {
            ...
            return new() { EventHistory.PowerToSummon(player.GetCirclePower(), 5 * activations) };
        },
    };
    private static Rune Bud => new()
    {
        ...
        Power = 5,
        Rarity = Rarity.Common,
        Text = "On Play: Permanently add +1 Power to the § Shard",
        OnEnter = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Bounce => new()
    {
        ...
        Power = 6,
        Rarity = Rarity.Common,
        Text = "On Play: Return the § Shard to hand",
        OnEnter = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Burn => new()
    {
        ...
        Power = 6,
        Rarity = Rarity.Rare,
        Text = "On Play: Add the § Shards Power to the summon then destroy the § Shard",
        OnEnter = (int selfIndex, Player player) =>
        {
            List<EventHistory> history = new();
            ...
            if (player.HasRuneAtIndex(prev))
            {
                ...
                history.Add(EventHistory.PowerToSummon(player.GetCirclePower(), power, prev));
    ...
    private static Rune Divinity => new()
    {
        ...
        Text = "On Play: Transform All other Shards in the summon to random Shards. All Shards has +5 Power",
        OnEnter = (int selfIndex, Player player) =>
        {
            List<EventHistory> history = new();
    ...
    private static Rune Faces => new()
    {
        ...
        Power = 2,
        Rarity = Rarity.Rare,
        Text = "On Activate: Transform ¦ Shard to the § Shard",
        OnActivate = (int selfIndex, Player player) =>
        {
            int prev = Player.CircularIndex(selfIndex - 1);
    ...
    private static Rune Fake => new()
    {
        ...
        Power = 8,
        Rarity = Rarity.Common,
        Text = "On Activate: Transform ¦ Shard to a random Shard",
        OnActivate = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Help => new()
    {
        ...
        Power = 5,
        Rarity = Rarity.Common,
        Text = "On Play: ¦ Shards Power is multiplied by 2",
        OnEnter = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Inspire => new()
    {
        ...
        Power = 8,
        Rarity = Rarity.Common,
        Text = "On Activate: Add +7 to the summon if the § Shard is of higher rarity",
        OnActivate = (int selfIndex, Player player) =>
        {
            ...
            if (rune != null)
            {
                if ((int)rune.Rarity > (int)self.Rarity)
                {
                    ...
                    return new() { EventHistory.PowerToSummon(player.GetCirclePower(), 7) };
                }
            }
    ...
    private static Rune Martyr => new()
    {
        ...
        Power = 8,
        Rarity = Rarity.Common,
        Text  = "On Exile: Permanently add +10 Power to the § Shard",
    ...
    private static Rune Pain => new()
    {
        ...
        Power = 0,
        Rarity = Rarity.None,
        Text = "On Play: Destroy the ¦. Exile this Shard",
        OnEnter = (int selfIndex, Player player) =>
        {
            List<EventHistory> history = new();
            int next = Player.CircularIndex(selfIndex + 1);
    ...
    private static Rune Prune => new()
    {
        ...
        Power = 0,
        Rarity = Rarity.None,
        Text  = "On Activate: Exile § Shard. Exile this Shard",
        OnActivate = (int selfIndex, Player player) =>
        {
            List<EventHistory> history = new();
            int prev = Player.CircularIndex(selfIndex - 1);
    ...
    private static Rune Ravage => new()
    {
        ...
        Power = 4,
        Rarity = Rarity.Common,
        Text = "On Play: Activate the Shard two steps § to this one",
        OnEnter = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Reap => new()
    {
        ...
        OnEnter = (int selfIndex, Player player) =>
        {
            int circlePower = player.GetCirclePower();
            player.AddCirclePower(circlePower * 2); 
            return new() { EventHistory.PowerToSummon(player.GetCirclePower(), circlePower * 2) };
        },
    };
    ...
    private static Rune Repeat => new()
    {
        ...
        Power = 10,
        Rarity = Rarity.Common,
        Text = "Has +20 Power if there is no Shard in the ¦ slot",
        Aura = new()
        {
            new()
            {
    ...
    private static Rune Retry => new()
    {
        ...
        Power = 10,
        Rarity = Rarity.Rare,
        Text = "On Play: Activate the § Shard",
        OnEnter = (int selfIndex, Player player) =>
        {
    ...
    private static Rune Sacrifice => new()
    {
        ...
        Power = -10,
        Rarity = Rarity.Common,
        Text = "On Activate: ¦ Shards Power is multiplied by 3",
        OnActivate = (int selfIndex, Player player) =>
        {
            int index = Player.CircularIndex(selfIndex + 1);
            if (player.HasRuneAtIndex(index))
    ...
    private static Rune Shore => new()
    {
        ...
        Power = 0,
        Rarity = Rarity.Common,
        Text = "On Activate: Permanently add +2 Power to the § Shard",
        OnActivate = (int selfIndex, Player player) =>
        {
            Rune prev = player.GetRuneInCircle(selfIndex - 1);
            if (prev != null)
    ...
    private static Rune Start => new()
    {
        ...
        OnEnter = (int selfIndex, Player player) =>
        {
            ...
            return new() { EventHistory.PowerToSummon(player.GetCirclePower(), 5) };
        },
    };
    ...
    private static Rune Tides => new()
    {
        ...
        Power = 7,
        Rarity = Rarity.Common,
        Text  = "On Play: Swap the ¦ Shard with the § Shard",
        OnEnter = (int selfIndex, Player player) =>
        {
            int idx1 = Player.CircularIndex(selfIndex - 1);
            int idx2 = Player.CircularIndex(selfIndex + 1);
    ...
    private static Rune Trickle => new()
    {
        ...
        Power = 3,
        Rarity = Rarity.Common,
        Text  = "On Play: Add +5 Power to the ¦ Shard and +2 Power to the ¦ Shard after that",
        OnEnter = (int selfIndex, Player player) =>
        {
            List<EventHistory> history = new();
